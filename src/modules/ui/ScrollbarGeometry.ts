...
class $ScrollbarGeometry {
    ...
    public static scrollbarGeometry(orientation: 'vertical' | 'horizontal', region: RegionRect, scroll: ScrollState, minimumThumbCells = this.minimumThumbCells): BarGeometry | null {
        ...
        const reportedPosition = trueRange > 0 ? Math.round((clampedPosition / trueRange) * reportedRange) : 0;
