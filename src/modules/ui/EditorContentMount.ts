...
class $EditorContentMount {
    protected diff: DiffView.Instance | null = null;
    protected shownDiffIdentifier = '';
    protected markdown: MarkdownSplitView.Instance | null = null;
    protected shownMarkdownIdentifier = '';
    protected mounted: 'editor' | 'diff' | 'markdown' | null = 'editor';
    protected lastDiffLaidHeight = -1;
    ...
    protected mount(content: 'editor' | 'diff' | 'markdown'): void {
        ...
        if (content === 'editor')
            ...
            editorColumn.add(markdownContainer);
                ...
                this.diff = new DiffView.Class(renderer, theme, {
                    ...
                    onOpenFull: () => {
                        ...
                        if (currentWorkingPath)
                            workspaceSet.active.openFileInTab(currentWorkingPath);
                    },
            ...
            if (this.shownMarkdownIdentifier !== markdownIdentifier || !this.markdown) {
                ...
                this.markdown = new MarkdownSplitView.Class(renderer, theme, {
                    ...
                    showReferenceTooltip: (path, screenColumn, screenRow) => {
                        ...
                        tooltip.point(`Open ${label} (Ctrl/Cmd+click${bindingHint ? ` · ${bindingHint}` : ''})`, screenColumn, screenRow);
                    },
