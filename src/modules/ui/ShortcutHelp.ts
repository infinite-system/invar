...
class $ShortcutHelp {
    ...
    protected static get $mergedShortcutContexts() {
        ...
        Object.defineProperty(this, "$mergedShortcutContexts", { configurable: true, value: mergedShortcutContextsValue });
    ...
    protected static get $categoryByActionPrefix(): Record<string, string> {
        ...
        Object.defineProperty(this, "$categoryByActionPrefix", { configurable: true, value: categoryByActionPrefixValue });
    ...
    protected static get $fallbackTitleByActionIdentifier(): Record<string, string> {
        ...
        Object.defineProperty(this, "$fallbackTitleByActionIdentifier", { configurable: true, value: fallbackTitleByActionIdentifierValue });
    ...
    constructor(protected readonly keybindings: KeybindingRegistry.Instance, protected readonly commands: CommandRegistry.Instance) { }
    get open() {
        return ref(false);
    }
    ...
    protected titleFor(actionIdentifier: string): string {
        ...
        const fallbackTitle = this.fallbackTitleByActionIdentifier[actionIdentifier];
        if (fallbackTitle)
    ...
    protected categoryFor(actionIdentifier: string): string {
        ...
        return (this.categoryByActionPrefix[actionPrefix] ??
    ...
    scrollBy(rowDelta: number, viewportRows: number): void {
        ...
        this.scrollTop.value = Math.max(0, Math.min(this.scrollTop.value + rowDelta, maximumScrollTop));
    }
}
