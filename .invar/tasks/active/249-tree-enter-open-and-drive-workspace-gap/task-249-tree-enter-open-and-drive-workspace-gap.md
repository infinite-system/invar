...
1. **Enter on a freshly opened directory workspace does not open the
   ...
   tree?) or a documentation gap; fix the one it is. Either way `drive.md`
...
Done-test: a fresh builder following drive.md alone reaches an open scratch
file at --size 100000 with zero wrong turns; both fixes carry a driven
positive control.

## Invariants in scope

- `drive.md` / the drive tool's records; Quick Open's degraded-enumeration
...
- `report-35-structure-navigator-plugin-pane.md`, Bycatch items 5 and 6, and
