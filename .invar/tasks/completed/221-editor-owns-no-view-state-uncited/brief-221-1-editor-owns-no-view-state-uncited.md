...
Read first: [.invar/tasks/active/221-editor-owns-no-view-state-uncited/task-221-editor-owns-no-view-state-uncited.md](task-221-editor-owns-no-view-state-uncited.md),
then the record itself in [src/modules/editor/editor.invariants.md](../../../../src/modules/editor/editor.invariants.md), then
[project.decisions.md](../../../../project.decisions.md) entry *Fold state is document-adjacent persistence, not
a view property* (#218), and [.claude/skills/invariants/SKILL.md](../../../../.claude/skills/invariants/SKILL.md) for citation
rules.
...
- If the record still says something the newer records (#218's fold-state
  decision, [text.invariants.md](../../../../src/modules/text/text.invariants.md)'s document records) do NOT: cite it from the
...
in the file: [editor.invariants.md](../../../../src/modules/editor/editor.invariants.md) emits `one category is empty — fine while
