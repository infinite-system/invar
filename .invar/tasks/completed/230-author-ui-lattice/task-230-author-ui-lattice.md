# 230 — author [ui.lattice.md](../../../../src/modules/ui/ui.lattice.md): the ui records need the unification scroll has

State: COMPLETED — c669256f — [ui.lattice.md](../../../../src/modules/ui/ui.lattice.md) authored: five generators, three recurring shapes, eight compositions; 77->217 resolved links, 0 problems, all 61 records woven; six-finding bycatch converted to #239-#242
Created: 2026-07-29
Engine: claude
Environment: linux
Model: opus-5
...
[scroll.lattice.md](../../../../src/modules/ui/scroll.lattice.md) records how the scroll domain's records derive from and
...
text state survives replaceable projection* to [project.lattice.md](../../../../project.lattice.md), and the
pane/panel/keybinding/projection records now form a family with real
derivation structure that nothing records.

Model: [scroll.lattice.md](../../../../src/modules/ui/scroll.lattice.md). The lattice is not a list — it records DERIVATION
...
Scope note: whether ui compositions live in [project.lattice.md](../../../../project.lattice.md) or a new
[ui.lattice.md](../../../../src/modules/ui/ui.lattice.md) follows how scroll made the call — read its header for the
...
- [project.lattice.md](../../../../project.lattice.md) — the existing composition layer this must join, not
  duplicate.
- [scroll.lattice.md](../../../../src/modules/ui/scroll.lattice.md) — the structural model (read-only).

## Bycatch expected

Per [AGENTS.md](../../../../AGENTS.md)'s bycatch taxonomy, all seven categories; contract-layer gaps
...
- User instruction 2026-07-29 ("we are missing the [ui.lattice.md](../../../../src/modules/ui/ui.lattice.md) that will
  unify everything like [scroll.lattice.md](../../../../src/modules/ui/scroll.lattice.md) does — this has to be part of the
  loop").
