...
Read first: `.invar/tasks/active/230-author-ui-lattice/task-230-author-ui-lattice.md`
— it carries the scope, the model (`scroll.lattice.md`), and the placement
question (extend `project.lattice.md` vs a new `ui.lattice.md` — read scroll's
...
`project.lattice.md` — join it, do not duplicate it).
...
- `project.lattice.md` — the layer this joins.
- `scroll.lattice.md` — the structural model (read-only).
- `workspace.invariants.md` — *One provider creates every workspace buffer
  view* constrains the ui family from outside; the lattice should say how.

## Bycatch expected

Per AGENTS.md's taxonomy, all seven categories — contract-layer gaps
