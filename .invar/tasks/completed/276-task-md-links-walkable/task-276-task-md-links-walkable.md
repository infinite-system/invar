# 276 — [project.active-tasks.md](../../../../project.active-tasks.md) and task files link into the task records, walkable by click
...
User: "[project.active-tasks.md](../../../../project.active-tasks.md) and other task.md should link via md system
to the tasks and be walkable via click."

Two ends, one seam:

1. **The generated views emit links.** `tasks-status.ts write-active`
   generates [project.active-tasks.md](../../../../project.active-tasks.md) / [project.tasks-completed.md](../../../../project.tasks-completed.md);
...
Verify by driving: open [project.active-tasks.md](../../../../project.active-tasks.md), click a task link, land
in the record, click a report link, jump Back. Positive control: a link to
a missing file states the miss (never silent).

## Invariants in scope

- [markdown.invariants.md](../../../../src/modules/markdown/markdown.invariants.md) (link handling — likely a NEW record); the
