# Brief — #239: repair [ui.invariants.md](../../../../src/modules/ui/ui.invariants.md)'s rotted citations

Read first: [.invar/tasks/active/239-ui-contract-citation-repairs/task-239-ui-contract-citation-repairs.md](task-239-ui-contract-citation-repairs.md)
— it enumerates all six edits with exact lines, and
[report-230-author-ui-lattice.md](../230-author-ui-lattice/report-230-author-ui-lattice.md) in #230's completed folder carries the grep
evidence for each.
...
- [src/modules/ui/ui.invariants.md](../../../../src/modules/ui/ui.invariants.md) — the six edit sites, named in the task.
- [src/modules/ui/ui.lattice.md](../../../../src/modules/ui/ui.lattice.md) — every link must still resolve; quote the
  link count before and after (217 expected stable).

## Bycatch expected

Per [AGENTS.md](../../../../AGENTS.md)'s taxonomy, all seven categories — comment drift especially:
