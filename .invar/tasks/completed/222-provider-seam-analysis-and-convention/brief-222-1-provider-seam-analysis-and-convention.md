...
Read first:
1. `.invar/tasks/active/222-provider-seam-analysis-and-convention/task-222-provider-seam-analysis-and-convention.md`
...
1. `analysis-222-classification.md` — every namespace in `src/modules/system/`
...
2. `analysis-222-convention.md` — the convention text ready for AGENTS.md
...
3. `analysis-222-datastore-interface.md` — the `DataStore` seam sketch for
...
`.claude/skills/ste-expression/SKILL.md`, flavored. Report bycatch explicitly.
