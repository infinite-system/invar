...
## IN-PROGRESS (1)
- #536 [workspace-replace-consent-history](.invar/tasks/in-progress/536-workspace-replace-consent-history/task-536-workspace-replace-consent-history.md)  [building]
  `tmux attach -t invar/536-workspace-replace-consent-history`
...
## RECENTLY COMPLETED (last 15 of 236 — full log: project.tasks-completed.md)
