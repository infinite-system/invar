...
## IN-PROGRESS (1)
- #429 [layout-switcher-icon-tooltip](.invar/tasks/in-progress/429-layout-switcher-icon-tooltip/task-429-layout-switcher-icon-tooltip.md)  [READY delivered — builder idle, awaiting landing]
...
- #428 [fold-dense-rows-zero-margin-floor](.invar/tasks/active/428-fold-dense-rows-zero-margin-floor/task-428-fold-dense-rows-zero-margin-floor.md)
...
- #232 [file-tree-empty-outside-git-repo](.invar/tasks/active/232-file-tree-empty-outside-git-repo/task-232-file-tree-empty-outside-git-repo.md)
- #231 [agent-tmux-launch-and-list-defects](.invar/tasks/active/231-agent-tmux-launch-and-list-defects/task-231-agent-tmux-launch-and-list-defects.md)
- #229 [scale-parity-selection-smoke](.invar/tasks/active/229-scale-parity-selection-smoke/task-229-scale-parity-selection-smoke.md)
- #227 [dispatch-cuts-worktree-after-record-commit](.invar/tasks/active/227-dispatch-cuts-worktree-after-record-commit/task-227-dispatch-cuts-worktree-after-record-commit.md)
- #225 [system-invariants-rotted-enumeration](.invar/tasks/active/225-system-invariants-rotted-enumeration/task-225-system-invariants-rotted-enumeration.md)
- #210 [mutation-probes-for-semantic-weakening](.invar/tasks/active/210-mutation-probes-for-semantic-weakening/task-210-mutation-probes-for-semantic-weakening.md)
- #190 [pool-membership-must-be-earned](.invar/tasks/active/190-pool-membership-must-be-earned/task-190-pool-membership-must-be-earned.md)  [ACTIVE — premise corrected in place]
- #183 [quiet-lock-degrades-and-runs-anyway](.invar/tasks/active/183-quiet-lock-degrades-and-runs-anyway/task-183-quiet-lock-degrades-and-runs-anyway.md)  [ACTIVE — unfixed, and it has already cost samples]
- #182 [collect-until-false-success-wait](.invar/tasks/active/182-collect-until-false-success-wait/task-182-collect-until-false-success-wait.md)
- #181 [terminal-factory-platform-untested](.invar/tasks/active/181-terminal-factory-platform-untested/task-181-terminal-factory-platform-untested.md)  [ACTIVE — pairs with #180]
- #180 [no-smoke-runs-on-macos](.invar/tasks/active/180-no-smoke-runs-on-macos/task-180-no-smoke-runs-on-macos.md)  [ACTIVE — CRITICAL]
...
- #252 [activitybar-smoke-pre-satisfied-waits](.invar/tasks/active/252-activitybar-smoke-pre-satisfied-waits/task-252-activitybar-smoke-pre-satisfied-waits.md)
- #214 [panel-chrome-agent-close-intermittent](.invar/tasks/active/214-panel-chrome-agent-close-intermittent/task-214-panel-chrome-agent-close-intermittent.md)
- #213 [drive-quit-key-post-quit-frame-wait](.invar/tasks/active/213-drive-quit-key-post-quit-frame-wait/task-213-drive-quit-key-post-quit-frame-wait.md)
- #212 [markdown-100k-paste-focus-wait](.invar/tasks/active/212-markdown-100k-paste-focus-wait/task-212-markdown-100k-paste-focus-wait.md)
- #200 [input-byte-latency-above-baseline](.invar/tasks/active/200-input-byte-latency-above-baseline/task-200-input-byte-latency-above-baseline.md)
- #198 [selection-harness-pre-satisfied-wheels](.invar/tasks/active/198-selection-harness-pre-satisfied-wheels/task-198-selection-harness-pre-satisfied-wheels.md)
- #193 [fold-dense-contract-row-shortfall](.invar/tasks/active/193-fold-dense-contract-row-shortfall/task-193-fold-dense-contract-row-shortfall.md)  [ACTIVE — single unexplained miss]
- #176 [tabs-harness-retry-only-pass](.invar/tasks/active/176-tabs-harness-retry-only-pass/task-176-tabs-harness-retry-only-pass.md)
- #173 [grid-predicates-assume-contiguous-text](.invar/tasks/active/173-grid-predicates-assume-contiguous-text/task-173-grid-predicates-assume-contiguous-text.md)
- #167 [audio-narration-pool-timeout](.invar/tasks/active/167-audio-narration-pool-timeout/task-167-audio-narration-pool-timeout.md)
- #166 [latency-instrument-crashes-at-one-sample](.invar/tasks/active/166-latency-instrument-crashes-at-one-sample/task-166-latency-instrument-crashes-at-one-sample.md)
- #165 [glide-canary-zero-margin-boundary](.invar/tasks/active/165-glide-canary-zero-margin-boundary/task-165-glide-canary-zero-margin-boundary.md)
- #164 [panel-chrome-ascii-tier-timeout](.invar/tasks/active/164-panel-chrome-ascii-tier-timeout/task-164-panel-chrome-ascii-tier-timeout.md)  [ACTIVE — pre-existing, reproduced on BOTH populations]
...
- #154 [perf-baselines-reach-no-verdict](.invar/tasks/active/154-perf-baselines-reach-no-verdict/task-154-perf-baselines-reach-no-verdict.md)
- #153 [overlay-horizontal-fling-slower](.invar/tasks/active/153-overlay-horizontal-fling-slower/task-153-overlay-horizontal-fling-slower.md)  [ACTIVE — WAITING ON THE USER (a feel call)]
- #140 [real-terminal-freeze-capture](.invar/tasks/active/140-real-terminal-freeze-capture/task-140-real-terminal-freeze-capture.md)  [ACTIVE — deliberately NOT dispatched; waiting on one user check]
- #104 [editor-glide-monotonicity-deferred](.invar/tasks/active/104-editor-glide-monotonicity-deferred/task-104-editor-glide-monotonicity-deferred.md)  [ACTIVE (deferred by user decision)]
...
- #427 [quickopen-ranking-contract-record](.invar/tasks/active/427-quickopen-ranking-contract-record/task-427-quickopen-ranking-contract-record.md)
...
- #234 [navigation-getters-and-hop-depth-ratchet](.invar/tasks/active/234-navigation-getters-and-hop-depth-ratchet/task-234-navigation-getters-and-hop-depth-ratchet.md)
- #228 [source-text-keys-through-pane-context](.invar/tasks/active/228-source-text-keys-through-pane-context/task-228-source-text-keys-through-pane-context.md)
- #226 [clock-freeze-hook-and-getter-conversion](.invar/tasks/active/226-clock-freeze-hook-and-getter-conversion/task-226-clock-freeze-hook-and-getter-conversion.md)
- #224 [momentum-ambient-clock-default-parameter](.invar/tasks/active/224-momentum-ambient-clock-default-parameter/task-224-momentum-ambient-clock-default-parameter.md)
- #217 [split-geometry-aggregates-invariant](.invar/tasks/active/217-split-geometry-aggregates-invariant/task-217-split-geometry-aggregates-invariant.md)
- #136 [shared-scale-fixture-corpus-cache](.invar/tasks/active/136-shared-scale-fixture-corpus-cache/task-136-shared-scale-fixture-corpus-cache.md)
...
## RECENTLY COMPLETED (last 15 of 164 — full log: project.tasks-completed.md)
