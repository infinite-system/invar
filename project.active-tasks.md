...
## IN-PROGRESS (1)
- #535 [left-dock-search-surface](.invar/tasks/in-progress/535-left-dock-search-surface/task-535-left-dock-search-surface.md)  [building]
  `tmux attach -t invar/535-left-dock-search-surface`
...
## RECENTLY COMPLETED (last 15 of 235 — full log: project.tasks-completed.md)
