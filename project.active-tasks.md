...
- #494 [hidden-monitor-log-line-race-under-load](.invar/tasks/in-progress/494-hidden-monitor-log-line-race-under-load/task-494-hidden-monitor-log-line-race-under-load.md)  [READY delivered — builder idle, awaiting landing]
...
## RECENTLY COMPLETED (last 15 of 211 — full log: project.tasks-completed.md)
