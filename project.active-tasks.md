...
## IN-PROGRESS (1)
- #533 [tasks-header-pipes-and-dead-open-button](.invar/tasks/in-progress/533-tasks-header-pipes-and-dead-open-button/task-533-tasks-header-pipes-and-dead-open-button.md)  [READY delivered — builder idle, awaiting landing]
...
## RECENTLY COMPLETED (last 15 of 233 — full log: project.tasks-completed.md)
