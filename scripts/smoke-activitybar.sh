...
expect_frame_contains 'Space/Enter changes' 'Extensions view renders plugin controls'
...
expect_frame_contains 'Space/Enter changes' 'the chord switched the rendered content too'
